...
| S4 | Kalendoriaus prenumeratos nuoroda (.ics) su žetonu URL'e | M | M | žetonas atsitiktinis, perkuriamas profilyje; rodo tik naudotojo priminimus | jei nenaudojama — Nustatymai → Bendri nustatymai → „Leisti kalendoriaus prenumeratos nuorodas“ (išjungus visos nuorodos iškart nustoja veikti) | savininkas |
