...
urlpatterns = [
    ...
    path("contacts/<int:pk>/regitra/<str:kind>/", views.person_regitra, name="person-regitra"),
    ...
    path("settings/system-health/", views.settings_system_health, name="settings-system-health"),
